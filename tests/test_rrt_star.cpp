...
int main(void) {
	...
	auto obstacles = std::vector<Polygon>(
			{Rectangle(Point(20, 20), Point(40, 40)), Rectangle(Point(80, 80), Point(90, 90)),
			 Rectangle(Point(20, 40), Point(60, 55)), Rectangle(Point(80, 100), Point(90, 20)),
			 Polygon({Point(20, 20), Point(30, 20), Point(35, 30), Point(30, 40), Point(20, 40), Point(15, 30)})});
	...
	auto t0 = clock::now();
	auto pathFound = rrt_star.findPath(Point(0, 0), Point(100, 100));
	if (!pathFound) {
